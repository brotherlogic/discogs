...
var file_discogs_proto_rawDesc = []byte{
	...
	0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x61, 0x74, 0x6e, 0x6f, 0x42, 0x27,
...
var file_discogs_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_discogs_proto_goTypes = []interface{}{
	(*Field)(nil),      // 0: discogs.Field
	(*Folder)(nil),     // 1: discogs.Folder
	(*Pagination)(nil), // 2: discogs.Pagination
	(*Format)(nil),     // 3: discogs.Format
	(*User)(nil),       // 4: discogs.User
	(*Release)(nil),    // 5: discogs.Release
	(*Label)(nil),      // 6: discogs.Label
}
var file_discogs_proto_depIdxs = []int32{
	3, // 0: discogs.Release.formats:type_name -> discogs.Format
	6, // 1: discogs.Release.labels:type_name -> discogs.Label
